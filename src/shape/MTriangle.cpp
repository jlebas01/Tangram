...
MTriangle::~MTriangle()= default;

MTriangle::MTriangle(const std::pair<double,double> point1, const std::pair<double,double> point2, const std::pair<double,double> point3){
